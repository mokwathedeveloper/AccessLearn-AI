...
import { ArrowLeft, FileText, FileAudio, Sparkles, BookOpen, Clock, Download, Share2, Loader2 } from 'lucide-react'
      ...
      <div className="container mx-auto p-6 md:p-10 max-w-6xl space-y-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
             ...
             <Badge variant={material.status === 'completed' ? 'success' : 'processing'} className="rounded-xl px-4 py-1 uppercase text-[10px] font-black">
                {material.status}
             </Badge>
          </div>
        </div>
